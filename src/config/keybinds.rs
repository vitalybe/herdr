...
pub struct Keybinds {
    ...
    pub scratch_terminal: ActionKeybinds,
    pub scratch_terminal_to_tab: ActionKeybinds,
...
impl Config {
    pub(super) fn validated_keybinds(&self) -> (Option<String>, KeyCombo, Vec<String>, Keybinds) {
        ...
        let mut keybinds = Keybinds {
            ...
            scratch_terminal: empty_action!(),
            scratch_terminal_to_tab: empty_action!(),
        ...
        for source in [BindingSource::User, BindingSource::Default] {
            ...
            apply_action!(keybinds.scratch_terminal, scratch_terminal, source);
            apply_action!(
                keybinds.scratch_terminal_to_tab,
