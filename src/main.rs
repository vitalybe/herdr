...
# undo_close = "prefix+u"
# scratch_terminal = "ctrl+backtick"           # show/hide the scratch terminal modal
# scratch_terminal_to_tab = "ctrl+shift+backtick" # move the scratch terminal into its own tab
